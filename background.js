...
// [ask confirmation, close tab on tab save, close window on window save, open session in current window, open session action]
chrome.runtime.onInstalled.addListener(function() {
  chrome.storage.sync.set({
    "prev_state": null,
    "preference_arr": [true, false, false, false, 1],
    "names_arr": [],
    "num_sessions": 0
  });
});
